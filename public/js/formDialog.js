    ...
    $('body').mouseleave(function(){
        ...
        dialogHtml += '<div class="dialogForm">';
            dialogHtml += '<div class="elem">';
                dialogHtml += '<h2>Odchodzisz? Zostaw swój e-mail <span>w zamian otrzymasz kod rabatowy 10%</span></h2>';
            dialogHtml += '</div>';
            dialogHtml += '<div class="elem">';
            ...
            dialogHtml += '</div>';
            dialogHtml += '<div class="elem">';
                dialogHtml += '<input class="send-email" id="send-email" type="button" value="Wyślij e-mail" />';
            dialogHtml += '</div>';
        dialogHtml += '</div>';
